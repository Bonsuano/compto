...
COMPTO_GENERATED_RS_FILE = PROJECT_PATH / "src/generated/comptoken_generated.rs"
...
def setStaticPda():
    run(
        f"solana find-program-derived-address {getProgramId()} --output json > {COMPTO_GLOBAL_DATA_ACCOUNT_JSON}"
    )
