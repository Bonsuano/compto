...
async function test_dailyDistributionEvent() {
    ...
    const validBlockhash = finalGlobalData.data.validBlockhashes;
    const dailyDistributionData = finalGlobalData.data.dailyDistributionData;
    ...
    Assert.assert(finalInterestBank.data.amount > interest_bank.data.amount, "interest bank has increased");
    ...
    Assert.assert(finalUbiBank.data.amount > ubi_bank.data.amount, "interest bank has increased");
}
