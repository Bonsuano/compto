...
// static COMPTOKEN_ADDRESS: Pubkey = pubkey!("42mrBXsurtZmiyKu6JpchUvhukjJKeUD2QNUA5TAbyjg");
// ^^^ DO NOT TOUCH. ^^^
...
use comptoken_generated::COMPTOKEN_ADDRESS;
use comptoken_generated::COMPTO_STATIC_ADDRESS_SEED;
